...
alter_table(cs, f"ALTER TABLE {utl.admin} ADD min_withdrawal INT(11) NOT NULL DEFAULT 0.10 AFTER support")
...
alter_table(cs, f"ALTER TABLE {utl.mbots} ADD amount FLOAT NOT NULL DEFAULT 0 AFTER country_id")
...
alter_table(cs, f"ALTER TABLE {utl.countries} ADD amount FLOAT NOT NULL DEFAULT 0 AFTER area_code")
...
alter_table(cs, f"ALTER TABLE {utl.countries} ADD occupied INT NOT NULL DEFAULT 0 AFTER is_useable")
alter_table(cs, f"ALTER TABLE {utl.countries} ADD capacity INT NOT NULL DEFAULT 100 AFTER occupied")
...
alter_table(cs, f"ALTER TABLE {utl.users} ADD balance FLOAT NOT NULL DEFAULT 0 AFTER user_id")
...
alter_table(cs, f"ALTER TABLE {utl.withdrawal} ADD amount FLOAT NOT NULL DEFAULT 0 AFTER user_id")
